...
void NeoSystem::translate_long_name(ROM_DEF* drv)
{
	static std::map<std::string_view, std::string_view> s_drvName2DisplayName = {
		...
		{ "fbfrenzy", "F - 疯狂美式足球" },
		{ "fightfev", "K - 狂热格斗" },
		{ "fightfeva", "K - 狂热格斗 (第2套)" },
		{ "kabukikl", "T - 天外魔境真传" },
		// G
		{ "galaxyfg", "Y - 银河快打 宇宙战士" },
		{ "ganryu", "W - 武藏严流记" },
		{ "garou", "E - 饿狼传说 狼之印记" },
		{ "garoubl", "E - 饿狼传说 狼之印记 (盗版)" },
		{ "garouo", "E - 饿狼传说 狼之印记 (第2套)" },
		{ "garoup", "E - 饿狼传说 狼之印记 (工程版)" },
		{ "ghostlop", "G - 鬼精灵投球手" },
		{ "goalx3", "S - 射门！射门！射门！" },
		{ "gpilots", "M - 魔鬼飞行员" },
		{ "gpilotsh", "M - 魔鬼飞行员 (第2套)" },
		{ "gururin", "M - 梦幻天堂" },
		// I
		{ "ironclad", "C - 超铁战机" },
		{ "ironclado", "C - 超铁战机 (旧的工程版)" },
		// J
		{ "janshin", "Q - 雀神传说 寻找麻将大师" },
		{ "jockeygp", "S - 赛马大奖赛 (有Bug)" },		
		// K
		{ "karnovr", "D - 斗士的历史2 卡诺夫的复仇" },
		// { "kf2k2mp", "" }, { "kf2k2mp2", "" }, { "kf2k2pla", "" }, { "kf2k2pls", "" },
		// { "kf2k3bl", "" }, { "kf2k3bla", "" }, { "kf2k3pcb", "" }, { "kf2k3pl", "" }, { "kf2k3upl", "" },
		// { "kf2k5uni", "" },
		// { "kf10thep", "" },
		{ "kizuna", "F - 风云默示录2 超级组队战" },
		// { "kof2k4se", "" },
		// { "kof10th", "" },
		{ "kotm", "G - 怪兽之王1" },
		{ "kotmh", "G - 怪兽之王1 (第2套)" },
		...
		{ "ncommand", "R - 忍者指令" },
		{ "neobombe", "N - Neo炸弹人" },
		{ "neocup98", "N - NeoGeo杯98 胜利之路" },
		{ "neodrift", "N - Neo拉力赛车 新的技术" },
		{ "neomrdo", "N - Neo嘟先生" },
		{ "ninjamas", "B - 霸王忍法帖" },
		{ "nitd", "W - 午夜噩梦" },
		{ "nitdbl", "W - 午夜噩梦 (盗版)" },
		{ "turfmast", "N - Neo大联盟高尔夫" },
		// O
		{ "overtop", "K - 跨越巅峰" },
		// P
		{ "joyjoy", "Y - 阳光方块" },
		...
		{ "rbff1a", "Z - 真饿狼传说1 (修复版)" },
		{ "rbff2", "Z - 真饿狼传说2 新的来者" },
		{ "rbff2h", "Z - 真饿狼传说2 新的来者 (第2套)" },
		{ "rbff2k", "Z - 真饿狼传说2 新的来者 (韩版)" },
		{ "rbffspec", "Z - 真饿狼传说1 特别版" },
		{ "ridhero", "F - 风速英雄 (有bug)" },
		{ "ridheroh", "F - 风速英雄 (第2套 有bug)" },
		{ "roboarmy", "J - 机甲神兵" },
		{ "rotd", "L - 龙吼 (有bug)" },
		// S
		{ "mosyougi", "J - 将棋达人" },
		{ "s1945p", "D - 打击者1945加强版" },
		{ "samsh5sp", "S - 侍魂5 特别版" },
		// { "samsh5sph", "S - 侍魂5 特别版 (第2套)" },
		// { "samsh5spn", "S - 侍魂5 特别版 (第3套)" },
		{ "samsho", "S - 侍魂1" },
		// { "samshoh", "S - 侍魂1 (第2套)" },
		{ "samsho2", "S - 侍魂2 霸王丸地狱变" },
		{ "samsho3", "S - 侍魂3 斩红郎无双剑" },
		// { "samsho3h", "S - 侍魂3 斩红郎无双剑 (第2套)" },
		// { "fswords", "S - 侍魂3 斩红郎无双剑 (韩版)" },
		{ "samsho4", "S - 侍魂4 天草降临" },
		{ "samsho5", "S - 侍魂5" },
		// { "samsho5b", "S - 侍魂5 (盗版 有Bug)" },
		// { "samsho5h", "S - 侍魂5 (第2套)" },
		{ "savagere", "F - 风云默示录" },
		{ "sdodgeb", "R - 热血超级躲避球" },
		{ "sengoku", "Z - 战国传承1" },
		...
		{ "sengoku2", "Z - 战国传承2" },
		{ "sengoku3", "Z - 战国传承3" },
		{ "shocktr2", "T - 突击骑兵2 第二分队" },
		{ "lans2004", "T - 突击骑兵2 第二分队 (盗版 有Bug)" },
		{ "shocktro", "T - 突击骑兵1" },
		{ "shocktra", "T - 突击骑兵1 (第2套)" },
		{ "socbrawl", "J - 机器人足球" },
		{ "socbrawla", "J - 机器人足球 (第2套)" },
		{ "spinmast", "Q - 强尼大冒险" },
		{ "ssideki", "D - 得点王1" },
		{ "ssideki2", "D - 得点王2 真实格斗足球" },
		{ "ssideki3", "D - 得点王3 下一个荣耀" },
		{ "ssideki4", "D - 得点王4 终极十一人" },
		{ "stakwin", "S - 赛马冠军1" },
		{ "stakwin2", "S - 赛马冠军2" },
		{ "strhoop", "J - 街头篮球" },
		{ "svc", "Q - 拳皇对街霸" },
		{ "svcboot", "Q - 拳皇对街霸 (盗版 有Bug)" },
		{ "svcpcb", "Q - 拳皇对街霸 (JAMMA标准主板 第1套 有Bug)" },
		{ "svcpcba", "Q - 拳皇对街霸 (JAMMA标准主板 第2套 有Bug)" },
		{ "svcplus", "Q - 拳皇对街霸加强版 (盗版 第1套 有Bug)" },
		{ "svcplusa", "Q - 拳皇对街霸加强版 (盗版 第2套 有Bug)" },
		...
		// { "kof99p", "Q - 拳皇99 (工程版)" },
		{ "kof2000", "Q - 拳皇2000" },
		// { "kof2000n", "Q - 拳皇2000 (未加密)" },
		{ "kof2001", "Q - 拳皇2001" },
		// { "kof2001h", "Q - 拳皇2001 (第2套)" },
		{ "kof2002", "Q - 拳皇2002" },
		// { "kof2002b", "Q - 拳皇2002 (盗版 有Bug)" },
		{ "kof2003", "Q - 拳皇2003" },
		// { "kof2003h", "Q - 拳皇2003 (第2套)" },
		{ "lastblad", "Y - 月华剑士1" },
		// { "lastbladh", "Y - 月华剑士1 (第2套)" },
		// { "lastsold", "Y - 月华剑士1 (韩版)" },
		{ "lastbld2", "Y - 月华剑士2" },
		{ "superspy", "D - 谍报飞龙" },
		{ "tophuntr", "D - 顶尖猎人" },
		// { "tophuntra", "D - 顶尖猎人 (第2套)" },
		{ "totcarib", "J - 加勒比宝藏" },
		{ "tpgolf", "D - 顶尖高尔夫" },
		{ "trally", "J - 极速英豪" },
		{ "twinspri", "M - 梦幻小妖精" },
